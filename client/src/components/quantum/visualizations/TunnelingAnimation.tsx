    ...
    >
      ...
      <motion.div
        ...
        animate={isSubmitting ? {
          borderColor: ["rgba(100, 255, 218, 0.3)", "rgba(100, 255, 218, 1)", "rgba(100, 255, 218, 0.3)"],
        } : {}}
      ...
      >
        <h3 className="text-2xl font-semibold mb-6 text-center text-quantum-cyan" data-testid="contact-form-title">
          {t('sections.tunneling.contactForm')}
        </h3>

        <div className="grid md:grid-cols-2 gap-6 mb-6">
          <div>
            <Label htmlFor="name" className="block text-sm font-medium mb-2" data-testid="name-label">
          ...
          <div>
            <Label htmlFor="email" className="block text-sm font-medium mb-2" data-testid="email-label">
        ...
        <div className="mb-6">
          <Label htmlFor="message" className="block text-sm font-medium mb-2" data-testid="message-label">
          ...
          {form.formState.errors.message && (
            <p className="text-sm text-destructive mt-1" data-testid="message-error">
        ...
        <div className="text-center">
          ...
          >
            <span className="relative z-10">{t('sections.tunneling.submit')}</span>
            <motion.div
            ...
            {isSubmitting && (
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-sm text-quantum-cyan" data-testid="tunneling-probability-text">
                    {t('sections.tunneling.tunnelingProbability')} <span data-testid="tunneling-probability">{Math.round(tunnelingProgress)}</span>%
                  </div>
                </div>
        ...
        {showSuccess && (
          ...
          >
            <div className="text-center">
              ...
              />
              <h4 className="text-2xl font-bold text-green-400 mb-2" data-testid="success-title">
